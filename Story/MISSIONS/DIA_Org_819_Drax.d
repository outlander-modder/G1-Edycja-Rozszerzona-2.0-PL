...
FUNC VOID  Org_819_Drax_Creatures_Info()
{
	...
	if ( (Knows_GetTeeth == FALSE)||(Knows_GetFur == FALSE)||(Knows_GetClaws == FALSE)||(Knows_GetHide == FALSE) )
	{
		...
		{
			Info_AddChoice(Org_819_Drax_Creatures,"Wycinanie sad³a (koszt: 1 punkt umiejêtnoœci, 50 bry³ek rudy)",org_819_drax_creatures_fat);
		};
	}
	else
	{
...
func void org_819_drax_creatures_fat()
{
	AI_Output(other,self,"Org_819_Drax_Creatures_Fat_15_00");	//Jak wycinaæ sad³o kretoszczurów?
	if(Npc_HasItems(other,ItMiNugget) >= 50)
	{
		if(other.lp >= 1)
		{
			...
			AI_Output(self,other,"Org_819_Drax_Creatures_Fat_06_01");	//Sad³o kretoszczurów to cenny sk³adnik alchemiczny i kucharski.
			AI_Output(self,other,"Org_819_Drax_Creatures_Fat_06_02");	//Musisz dobrze naci¹æ brzuch kretoszczura. Wbij nó¿ w gard³o i przetnij ca³e cia³o, a¿ do podbrzusza. 
			AI_Output(self,other,"Org_819_Drax_Creatures_Fat_06_03");	//Potem delikatnie wyjmij p³aty t³uszczu.
			knows_getfat = TRUE;
