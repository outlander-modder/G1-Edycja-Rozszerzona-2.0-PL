...
//#####################################################################
var int monolog;
const int SLEEPABIT = 0;
const int FAJKA = 1;
const int GOTOWANIE = 2;
const int ALCHEMIA = 3;

const string NOTE_KITCHEN = "Umiejêtnoœci kucharskie";

var int knows_wurzelsuppe;
var int knows_meatbugragout;
var int knows_scabroth;
var int knows_crawlersoup;
var int knows_mushroomssoup;
var int knows_huntersstew;
var int knows_berryssoup;
var int knows_moleratsoup;
var int knows_ricestew;

const string NOTE_ALCHEMY = "Umiejêtnoœci alchemiczne";

var int knows_hp_elixier;
var int knows_hp_essenz;
var int knows_hp_extract;
var int knows_hp_easyextract;
var int knows_mana_elixier;
var int knows_mana_essenz;
var int knows_mana_extract;
var int knows_mana_easyextract;
var int knows_sprint_1;
var int knows_sprint_2;
var int knows_sprint_3;
var int knows_str_mixture;
var int knows_dex_mixture;
var int knows_mana_mixture;
var int knows_hp_mixture;
var int knows_wine;
var int knows_ricealco;

var int Knows_GetMeatbugs;
var int Knows_GetFat;