...
const int	Value_Wurzelsuppe	=	 3;		const int	Mana_Wurzelsuppe	=	 7;
const int	Value_Ragout		=	 4;		const int	HP_Ragout			=	 9;
const int	Value_CrawlerSuppe	=	10;		const int	HP_CrawlerSuppe		=	15;		const int	Mana_CrawlerSuppe		=	15;
...
instance ITMI_ALCHEMY_ZUCKER_01(C_Item)
{
	name = "Cukier";
	mainflag = ITEM_KAT_NONE;
	flags = ITEM_MULTI;
...
func void UseSoup()
{
	Npc_ChangeAttribute(self,ATR_MANA,MANA_WURZELSUPPE);
...
func void UseMeatbugragout()
{
	var int FoodEffect_BugSoup;
	Npc_ChangeAttribute(self,ATR_HITPOINTS,HP_Ragout);
	FoodEffect_BugSoup + 1;
	if (FoodEffect_BugSoup == 40)
	{
	FoodEffect_BugSoup = 0;
	B_RaiseAttribute(ATR_HITPOINTS_MAX,1);
	};
};


instance ITFOSCABROTH(C_Item)
{
	name = "Rosó³ ze œcierwojada";
	mainflag = ITEM_KAT_FOOD;
	flags = ITEM_MULTI;
	value = 10;
	visual = "ItFo_Meatbugragout_01.3ds";
...
func void usescabroth()
{
	Npc_ChangeAttribute(self,ATR_HITPOINTS,30);
};


var int eat_crawlersoup;
...
{
	Npc_ChangeAttribute(self,ATR_HITPOINTS,HP_CrawlerSuppe);
	Npc_ChangeAttribute(self,ATR_MANA,MANA_CRAWLERSUPPE);
	if(Npc_IsPlayer(self))
	{
		EAT_CRAWLERSOUP = EAT_CRAWLERSOUP + 1;
		if(EAT_CRAWLERSOUP >= 10)
		{
			EAT_CRAWLERSOUP = 0;
...
var int eat_mushroomssoup;

instance ITFOMUSHROOMSSOUP(C_Item)
{
	name = "Zupa grzybowa";
	mainflag = ITEM_KAT_FOOD;
	flags = ITEM_MULTI;
...
func void usemushroomssoup()
{
	Npc_ChangeAttribute(self,ATR_HITPOINTS,55);
	if(Npc_IsPlayer(self))
	{
		EAT_MUSHROOMSSOUP = EAT_MUSHROOMSSOUP + 1;
		if(EAT_MUSHROOMSSOUP >= 10)
		{
			EAT_MUSHROOMSSOUP = 0;
			B_RaiseAttribute(ATR_HITPOINTS_MAX,1);
		};
...
var int eat_huntersstew;

instance ITFOHUNTERSSTEW(C_Item)
{
	name = "Gulasz myœliwski";
	mainflag = ITEM_KAT_FOOD;
	flags = ITEM_MULTI;
	value = 20;
	visual = "DB_ITFO_BLUTFLIEGENSUPPE.3ds";
	material = MAT_LEATHER;
	on_state[0] = usehuntersstew;
	scemeName = "RICE";
	description = name;
	text[1] = NAME_Bonus_HP;
	count[1] = 50;
...
func void usehuntersstew()
{
	Npc_ChangeAttribute(self,ATR_HITPOINTS,50);
	if(Npc_IsPlayer(self))
	{
		EAT_HUNTERSSTEW = EAT_HUNTERSSTEW + 1;
		if(EAT_HUNTERSSTEW >= 10)
		{
			EAT_HUNTERSSTEW = 0;
...
var int eat_berryssoup;

instance ITFOBERRYSSOUP(C_Item)
{
	name = "Zupa jagodowa";
	mainflag = ITEM_KAT_FOOD;
	flags = ITEM_MULTI;
...
func void useberryssoup()
{
	Npc_ChangeAttribute(self,ATR_HITPOINTS,45);
	if(Npc_IsPlayer(self))
	{
		EAT_BERRYSSOUP = EAT_BERRYSSOUP + 1;
		if(EAT_BERRYSSOUP >= 10)
		{
			EAT_BERRYSSOUP = 0;
...
func void usemoleratsoup()
{
	Npc_ChangeAttribute(self,ATR_HITPOINTS,50);
	Npc_ChangeAttribute(self,ATR_MANA,40);
	if(Npc_IsPlayer(self))
	{
		EAT_MOLERATSOUP = EAT_MOLERATSOUP + 1;
		if(EAT_MOLERATSOUP >= 10)
		{
			EAT_MOLERATSOUP = 0;
