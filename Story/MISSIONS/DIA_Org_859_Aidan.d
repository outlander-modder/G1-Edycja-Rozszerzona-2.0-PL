...
FUNC VOID  Org_859_Aidan_Creatures_Info()
{
	...
	if ( (Knows_GetTeeth == FALSE)||(Knows_GetFur == FALSE)||(Knows_GetClaws == FALSE)||(Knows_GetHide == FALSE) )
	{
		...
		if(Knows_GetFat == FALSE)
		{
			Info_AddChoice(Org_859_Aidan_Creatures,"Wycinanie sad³a (koszt: 1 punkt umiejêtnoœci, 50 bry³ek rudy)",Org_859_Aidan_Creatures_Fat);
		};
	}
	else
	{
...
func void Org_859_Aidan_creatures_fat()
{
	AI_Output(other,self,"Org_859_Aidan_Creatures_Fat_15_00");	//Jak wycinaæ sad³o kretoszczurów?
	if(Npc_HasItems(other,ItMiNugget) >= 50)
	{
		if(other.lp >= 1)
		{
			...
			PrintScreen("Nowa umiejêtnoœæ: Wycinanie sad³a",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
			AI_Output(self,other,"Org_859_Aidan_Creatures_Fat_06_01");	//Sad³o kretoszczurów to cenny sk³adnik alchemiczny i kucharski.
			AI_Output(self,other,"Org_859_Aidan_Creatures_Fat_06_02");	//Musisz dobrze naci¹æ brzuch kretoszczura. Wbij nó¿ w gard³o i przetnij ca³e cia³o, a¿ do podbrzusza. 
			AI_Output(self,other,"Org_859_Aidan_Creatures_Fat_06_03");	//Potem delikatnie wyjmij p³aty t³uszczu.
			knows_getfat = TRUE;
			Log_CreateTopic(GE_AnimalTrophies,LOG_NOTE);
			B_LogEntry(GE_AnimalTrophies,"Umiejêtnoœæ zdobywania sad³a kretoszczurów.");
		}
		else
		{
			AI_Output(self,other,"Org_859_Aidan_Creatures_KEINE_LP_06_00");	//Musisz najpierw zdobyæ trochê wiêcej doœwiadczenia. Inaczej moja wiedza bêdzie bezu¿yteczna.
			PrintScreen("Za ma³o punktów umiejêtnoœci!",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
		};
	}
	else
	{
		AI_Output(self,other,"Org_859_Aidan_Creatures_KEIN_ERZ_06_00");	//Najpierw chcê zobaczyæ trochê rudy. W tej kolonii nic nie ma za darmo!
	};
};
